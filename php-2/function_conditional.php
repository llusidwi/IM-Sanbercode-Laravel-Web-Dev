...
<body>
   ...
   function reverseString($str) {
    ...
    echo "Dwi Lusiana dibalik :  ". reverseString("Dwi Lusiana");
    echo "Sanbercode dibalik : ". reverseString("Sanbercode");
    echo "We Are Sanbers Developers dibalik : ". reverseString("We Are Sanbers Developers");
    echo "<br>";
    ...
    */
    ...
    $reversedStr = reverseString2($str2);
    if ($str2 === $reversedStr) {
        return "true";
    } else {
        return "false";
