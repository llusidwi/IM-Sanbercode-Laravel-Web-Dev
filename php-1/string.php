...
<body>
    ...
    <?php   
        ...
        */
        ...
        echo "<br> Kata Ketiga: ". substr($string2, 6, 4) . "<br>";
        ...
        */
        ...
        echo "<br> New String :" . str_replace("sexy", "awesome", $string3)
